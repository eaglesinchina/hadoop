...
public class App {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
        ...
        //输出
        FileOutputFormat.setOutputPath(job,new Path("/home/centos/rmp-part"));
        //等待工作完成
...
//        flag=false;
        if(flag){//第一步工作完成
            ...
            //输入
            FileInputFormat.addInputPath(job2,new Path("/home/centos/rmp-part"));
...
//            job.setNumReduceTasks(4);//多个reducer, 使得有空任务）
            ...
            //输出
            FileOutputFormat.setOutputPath(job2,new Path("/home/centos/rmp-part-res"));
            //等待工作完成
