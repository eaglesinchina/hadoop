...
public class App {//实现排序：    显示出所有（隐藏的重复数据）
    ...
    public static void main(String[] args) throws Exception {
       ...
       job.setGroupingComparatorClass(Comparto1.class);
        ...
        job.setReducerClass(Red1.class);
        job.setNumReduceTasks(1);//多个reducer, 使得有空任务）


        //输出
        Path path = new Path("/home/centos/txt/mr_sort-tmp-group-same");
