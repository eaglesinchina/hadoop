...
public class App {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
       ...
       // FileInputFormat.setMinInputSplitSize(job,500);// 2k
        ...
        //输出
        Path path = new Path("/home/centos/txt/sort-out");
        ...
        if(flag){//二次数据整理：  new  job2
            ...
            FileInputFormat.addInputPath(job2,new Path("/home/centos/txt/sort-out"));
            Path path2 = new Path("/home/centos/txt/sort-final");
            ...
            if(flag2){//三次作业完成：  再次排序
                ...
                FileInputFormat.addInputPath(job3,new Path("/home/centos/txt/sort-final"));
