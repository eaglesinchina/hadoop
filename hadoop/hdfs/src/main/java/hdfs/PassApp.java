...
public class PassApp {
    public static void main(String[] args) throws Exception {
        ...
        //设置输出路径
        FileOutputFormat.setOutputPath(job, new Path("/home/centos/txt/total-sort-pwd"));
        ...
        //设置采样数据地址
        TotalOrderPartitioner.setPartitionFile(job.getConfiguration(),new Path("/home/centos/txt/total-sample"));
